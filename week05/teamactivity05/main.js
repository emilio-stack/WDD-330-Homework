...
export default class Hikes {
  ...
  showHikeList() {
    // First iterate through each hike object
    hikesList.forEach(function(hikeObject) {
      // Next iterate through each key in the object
      Object.keys(hikeObject).forEach(key => {
        var li = document.createElement('li')
        // If the key is an img src, we will need to add an img element to hold the img
        if (key == "imgSrc") {
        ...
        // Otherwise insert the value into the list element
        else {
